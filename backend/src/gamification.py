...
BADGES = {
    ...
    "perfect_week": {"name": "Perfect Week", "icon": "⭐", "desc": "Complete all due habits for 7 consecutive days"},
    "centurion": {"name": "Centurion", "icon": "💯", "desc": "Reach 100 total habit completions"},
}
...
def check_new_badges(logs_df, habits_df, current_badges):
    ...
    # 3. Centurion (100 total completions)
    if "centurion" not in current_badges and len(logs_df) >= 100:
        new_unlocked.append("centurion")
